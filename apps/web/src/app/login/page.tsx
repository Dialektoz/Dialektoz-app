      ...
      <div className="w-full max-w-md px-6 z-10">
        <div className="bg-card/40 backdrop-blur-xl border border-primary/20 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 p-3.5 mb-6 border border-border/60 hover:border-primary/50 hover:bg-white/5 rounded-xl transition-all active:scale-95 group"
          >
            ...
            <span className="text-white font-medium text-sm">Continuar con Google</span>
          </button>
