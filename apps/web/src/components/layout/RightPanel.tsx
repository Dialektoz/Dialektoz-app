...
export default function RightPanel() {
  return (
    <aside className="w-[280px] lg:w-[320px] xl:w-[340px] bg-background flex flex-col py-6 px-4 lg:px-6 overflow-y-auto shrink-0 gap-6 custom-scrollbar border-l border-border/10">
